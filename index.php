    ...
    <div class="container-fluid mt-2">
        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="loads/images/welcome4.jpg" style="max-height: 500px;" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>First slide label</h5>
                    <p>Some representatcarousel-item" data-bs-interval="2000">
                <img src="upive placeholder content for the first slide.</p>
                </div>
              </div>
